...
function(b,e){var d=b.px.width,f=b.px.start;"acen"==b.stain?(d-=h/2,b="p"==b.name[0]?"M "+f+" "+l+" l "+d+" 0 q "+h+" "+a/2+" 0 "+a+" l -"+d+" 0 z":"M "+(f+d+h/2)+" "+l+" l -"+d+" 0 q -"+(h+.5)+" "+a/2+" 0 "+a+" l "+d+" 0 z"):(0==e&&(f+=g-h/2,!0===m.config.multiorganism&&(f+=g)),e==c.bands.length-1&&(f-=g-h/2),b="M "+f+" "+l+" l "+d+" 0 l 0 "+a+" l -"+d+" 0 z");return b});"telocentric"!=c.centromerePosition?b.append("path").attr("class","p-ter chromosomeBorder "+c.bands[0].stain).attr("d","M "+(g-
