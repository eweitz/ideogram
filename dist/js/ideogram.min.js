...
},{"d3-request":5}],5:[function(require,module,exports){
...
},{"d3-collection":1,"d3-dispatch":2,"d3-dsv":3}],6:[function(require,module,exports){
...
},{"./ploidy":14}],10:[function(require,module,exports){
'use strict';
...
var _d2 = require('d3.promise');

var d3promise = _interopRequireWildcard(_d2);
    ...
    **/
    ...
    value: function getTaxids(callback) {
      ...
      if ('organism' in ideo.config) {
        ...
        if (taxids.length === 0) {
          promise = new _es6Promise.Promise(function (resolve) {
...
},{"./layouts/layout":12,"./model-adapter":13,"./ploidy":14,"./views/chromosome":17,"d3":6,"d3.promise":4,"es6-promise":7}],11:[function(require,module,exports){
"use strict";
...
exports.VerticalLayout = exports.SmallLayout = exports.PairedLayout = exports.HorizontalLayout = exports.Layout = undefined;
...
var _chromosomeUtil = require('./../views/chromosome-util');
...
var Layout = exports.Layout = function () {
  ...
  _createClass(Layout, [{
    ...
    value: function getChromosomeLabels(chrElement) {
      var util = new _chromosomeUtil.ChromosomeUtil(chrElement);
...
},{"./../views/chromosome-util":16,"d3":6}],13:[function(require,module,exports){
'use strict';
...
exports.ChromosomeUtil = undefined;
...
var ChromosomeUtil = exports.ChromosomeUtil = function () {
...
},{"d3":6}],17:[function(require,module,exports){
'use strict';
