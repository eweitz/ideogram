...
var Ideogram = function () {
  ...
  */
  ...
  _createClass(Ideogram, [{
    key: 'assemblyIsAccession',
    value: function assemblyIsAccession() {
    ...
    */
    ...
    value: function getAssemblyAndChromosomesFromEutils(callback) {
      ...
      asmSearch = ideo.esearch + '&db=assembly' + '&term=%22' + termStem + 'AND%20(%22latest%20refseq%22[filter])%20' + 'AND%20(%22chromosome%20level%22[filter]%20' + 'OR%20%22complete%20genome%22[filter])';
    ...
    value: function init() {
      ...
      promise.then(function (taxids) {
        ...
        for (i = 0; i < taxids.length; i++) {
          ...
          if (typeof accession !== 'undefined' && typeof chrBands === 'undefined' && taxid in bandDataFileNames) {
      ...
      function writeContainer() {
        if (ideo.config.annotationsPath) {
          __WEBPACK_IMPORTED_MODULE_0_d3__["json"](ideo.config.annotationsPath, // URL
          function (data) {
            // Callback
            ideo.rawAnnots = data;
          });
